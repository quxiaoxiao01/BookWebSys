    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#username").blur(function () {
                ...
                $.getJSON("http://localhost:8080/Book/user", "action=ajaxExistsUsername&username=" + username, function (data) {
            ...
            $("#sub_btn").click(function () {
                ...
                var $repwd = $("#repwd").val();
                if (!namePattern.test($repwd)) {
                    $(".errorMsg").text("确认密码不合法!");
                    return false;
...
<%--					<%=request.getAttribute("msg") == null ? "" : request.getAttribute("msg")%>--%>
                ...
                <div class="form">
                    <form action="user" method="post">
                        ...
                        <img id="code_img" alt="" src="kaptcha.jpg" style=" width: 80px; height: 30px">
                        <br/>
                        <br/>
